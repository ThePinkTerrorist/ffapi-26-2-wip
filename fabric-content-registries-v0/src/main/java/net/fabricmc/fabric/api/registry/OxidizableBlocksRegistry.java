...
public final class OxidizableBlocksRegistry {
	...
	// registerWeatheringCopperBlocks was removed for Minecraft 26.2: its underlying WeatheringCopperBlocks
	// type was replaced by WeatheringCopperCollection with a non-one-to-one API shape (see NeoForge's 26.2
	// migration primer). Nothing in Fabric API itself calls this convenience method - use registerNextStage
	// and registerWaxable directly instead, as shown above.
}
